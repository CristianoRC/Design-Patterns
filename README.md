...
Quando se fala de Design Patterns não podemos deixar de falar sobre o GOF(Gang Of Four), basicamente foram os responsáveis por organizar em um livro os principais desogn patterns usados na época(e aidna são muito usados), certamente voc6e já viu esse livro circulando por ái, nele você vai encotrar 23 padrões de projetos, mas na prática existem muitos outros que não estão lá.
